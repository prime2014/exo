      ...
      <Dialog blockScroll={false} footer={displayFooter()} draggable={false} header="Edit Post" visible={visible} onHide={closeModal} breakpoints={{'960px': '75vw'}} style={{width: '50vw', minHeight:"60vh"}}>
          ...
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
            <div>
              ...
              <textarea ref={textareaRef} defaultValue={props.post.post} onChange={(event)=> setPostUpdate({ post: event.target.value})} cols={70} rows={5} style={{ border:"1px solid #d4d4d4", margin:"5px", fontSize:"18px", borderRadius:"10px", outline:"3px solid #6697ff", color:"#888DA8", display:"none" }}/>
            </div>
            <div>
